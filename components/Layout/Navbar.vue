...
<template>
  <header
    class="max-w-[1440px] px-4 lg:px-0 mx-auto fixed inset-x-0 top-0 mt-10 z-50"
  >
    <div class="flex items-center justify-between">
      ...
      <div
        class="relative overflow-hidden flex gap-8 items-center rounded-full px-7 py-3 border border-white/10 bg-gradient-to-b from-black/60 to-black/40 backdrop-blur-sm"
      >
        <div
